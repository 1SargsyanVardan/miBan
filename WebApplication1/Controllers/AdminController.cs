...
namespace WebApplication1.Controllers
{
    ...
    public class AdminController : ControllerBase
    {
        ...
        public IActionResult RegisterUser([FromBody] UserRegisterRequest userModel)
        {
        ...
        public IActionResult RegisterUsers([FromBody] List<UserRegisterRequest> userModels)
        {
